...
export const testimonialRepository = new BaseRepository(prisma.testimonial, ["clientName", "designation", "content"]);
export const blogRepository = new BaseRepository(prisma.blog, ["title", "slug", "excerpt", "metaTitle"]);
export const serviceCategoryRepository = new BaseRepository(prisma.serviceCategory, ["name", "slug"]);
export const serviceRepository = new BaseRepository(prisma.service, ["title", "slug", "description", "metaTitle"]);
...
export const userRepository = {
  ...
  softDelete: (id: number) => prisma.user.update({ where: { id }, data: { deletedAt: new Date() } })
};
