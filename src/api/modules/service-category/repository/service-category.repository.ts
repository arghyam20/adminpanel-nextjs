...
export class ServiceCategoryRepository {
  private get model() { return prisma.serviceCategory; }
  ...
  async findBySlug(slug: string) { return this.model.findFirst({ where: { slug, ...this.baseWhere } }); }
  async create(data: CreateServiceCategoryDto) { return this.model.create({ data: data as never }); }
  async update(id: number, data: UpdateServiceCategoryDto) { return this.model.update({ where: { id }, data: data as never }); }
